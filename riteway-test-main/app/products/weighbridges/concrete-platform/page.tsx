    ...
    <section className="relative overflow-hidden border-b border-gray-100">
      ...
      <div className="absolute inset-0">
        <img
          ...
          alt="Rite-Way concrete platform weighbridge — pit type installation, Mohali Punjab"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            <div className="h-44 overflow-hidden">
              <img
                src="/images/products/weighbridges/pit-concrete-weighbridge.jpeg"
                alt="Rite-Way concrete platform weighbridge — pit type installation"
                className="w-full h-full object-cover"
              />
            </div>
          ...
          >
            <div className="h-44 overflow-hidden">
              <img
                ...
                alt="Rite-Way concrete platform weighbridge — pitless surface type"
                className="w-full h-full object-cover"
              />
            </div>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <img
              src="/images/products/weighbridges/pit-concrete-weighbridge.jpeg"
              alt="Rite-Way concrete platform weighbridge — pit type, flush with ground"
          ...
          <div>
            <img
              src="/images/products/weighbridges/pitless-weighbridge.jpeg"
              alt="Rite-Way concrete platform weighbridge — pitless surface type with ramps"
              className="w-full rounded-sm object-cover"
              style={{ aspectRatio: "4/3" }}
            />
