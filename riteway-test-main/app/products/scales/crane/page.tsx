  ...
  return (
    <section className="bg-white py-10 border-b border-gray-100">
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        <img
          src="/images/products/scales/crane-scale.png"
          alt="Rite-Way Crane Scale — hook suspended industrial weighing"
  ...
  return (
    <section className="bg-gray-50 py-10 border-b border-gray-100">
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        <img
          src="/images/products/scales/crane-scale.png"
          alt="Rite-Way Crane Scale in industrial use — material handling operation"
