                    ...
                    <div className="bg-white border border-gray-100 rounded-sm shadow-2xl overflow-hidden">
                      ...
                      <div className="grid grid-cols-2 p-5 gap-0">
                        ...
                        <div className="pr-5 border-r border-gray-100">
                          ...
                          {WEIGHBRIDGE_LINKS.map(({ label, href, highlight }) => (
                            <Link
                              key={href}
                              href={href}
                              onClick={closeAll}
                        ...
                        <div className="pl-5">
                          ...
                          {SCALE_LINKS.map(({ label, href, highlight }) => (
                            <Link
                              key={href}
                              href={href}
                              onClick={closeAll}
                      ...
                      <div className="bg-gray-50 border-t border-gray-100 px-5 py-2.5 flex items-center gap-5 text-xs text-gray-400">
                        ...
                        <span className="ml-auto">
                          <Link
                            href="/products"
                            onClick={closeAll}
                            className="text-[#1E3A5F] font-semibold hover:text-[#DC2626] transition-colors">
                            View all products →
                          </Link>
                        </span>
                      </div>
            ...
            <div className="flex items-center justify-between px-5 h-16 border-b border-gray-100 flex-shrink-0">
              <Link href="/" onClick={closeAll} className="flex flex-col leading-none">
                <span
                  ...
                  style={{ fontFamily: "Georgia, serif", fontStyle: "italic", fontSize: "1.3rem", lineHeight: 1 }}>
                  RITE-WAY
                </span>
                <span
                  className="text-[#1E3A5F] font-semibold mt-0.5"
                  style={{ fontSize: "0.43rem", letterSpacing: "0.16em", textTransform: "uppercase" }}>
                  Minebea Technologies™
                </span>
              </Link>
              <button onClick={closeAll} className="p-1.5 text-gray-400 hover:text-[#111827]" aria-label="Close menu">
                <X size={20} />
              </button>
            </div>
            ...
            <nav className="flex-1 overflow-y-auto px-3 py-3">
              ...
              {mobileProd && (
                <div className="ml-2 mb-1">
                  ...
                  {WEIGHBRIDGE_LINKS.map(({ label, href }) => (
                    <Link
                      key={href}
                      href={href}
                      onClick={closeAll}
